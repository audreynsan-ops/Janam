 ...
 * @endcode
 */
$settings['hash_salt'] = '3hAho_8m3AYnG3IV3o27h53e5x9GS6CrDoTO_eyiHw9bKxzHN7S-sXFVBR-RY7f9_8wsBDmuYw';
...
// Use those instead for compatibility with OVH.
 ...
 */
$config['mailer_transport.mailer_transport.smtp']['configuration']['user'] = getenv('SMTP_USERNAME');
$config['mailer_transport.mailer_transport.smtp']['configuration']['pass'] = getenv('SMTP_PASSWORD');
$config['mailer_transport.mailer_transport.smtp']['configuration']['host'] = getenv('SMTP_HOST');
$config['mailer_transport.mailer_transport.smtp']['configuration']['port'] = getenv('SMTP_PORT');
...
if (file_exists(__DIR__ . '/settings.ovh.php')) {
  require_once __DIR__ . '/settings.ovh.php';
}
